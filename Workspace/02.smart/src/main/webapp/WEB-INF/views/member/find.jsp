					...
					<form method="post" action="resetPassword">
						...
						<div class="form-floating mb-3">
							<input class="form-control" type="text" name="email" required
								placeholder="이메일을 입력해주세요"> <label>이메일</label>
						</div>
						<div class="d-flex gap-3 justify-content-center">
							<a class="btn btn-primary form-control py-3"
								onclick="$('form').submit()">확인</a> <a
								class="btn btn-outline-primary form-control py-3" href="login">취소</a>
						</div>
					</form>
				</div>
			</div>
